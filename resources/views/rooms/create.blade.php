...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Add New Room') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('rooms.store') }}">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-6">
                                <select id="gender_type" class="form-control @error('gender_type') is-invalid @enderror" name="gender_type" required>
                                    <option value="" disabled {{ old('gender_type') == '' ? 'selected' : '' }}>Select Gender</option>
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="room_number" type="text" class="form-control @error('room_number') is-invalid @enderror" name="room_number" value="{{ old('room_number') }}" required autocomplete="room_number" autofocus>
                                @error('room_number')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
